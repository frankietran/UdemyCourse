...
class GoogleAuthenticationPopup(BasePage):
    ...
    def enter_email(self, email):
        self.dc.send_keys_to_element(email, By.CSS_SELECTOR, self.email_input_locator)

    def click_email_next(self):
        self.dc.click_element(By.CSS_SELECTOR, self.email_next_button_locator)

    def switched_to_password_screen(self):
        assert self.dc.wait_for_element_to_be_available(By.CSS_SELECTOR, self.password_input_locator)

    def enter_password(self, password):
        self.dc.send_keys_to_element(password, By.CSS_SELECTOR, self.password_input_locator)

    def click_password_next(self):
        self.dc.click_element(By.CSS_SELECTOR, self.password_next_button_locator)
