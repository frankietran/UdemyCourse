...
class HomePage(BasePage):
    ...
    browse_file_locator = "div.gi-coverAskForm-fileResult div:nth-child({}) label input[type='file']"
    submit_problem_locator = "button#submit-button-payment"

    def enter_problem_description(self, problem_des):
        self.dc.wait_to_click(By.CSS_SELECTOR, self.problem_des_locator, 20, 5)
        self.dc.send_keys(problem_des, By.CSS_SELECTOR, self.problem_des_locator)

    def upload_file(self, problem_file_path):
        self.dc.wait_to_click(By.CSS_SELECTOR, self.file_options_locator.format(self.upload_file_index), 20, 5)
